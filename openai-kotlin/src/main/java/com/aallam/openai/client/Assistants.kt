...
interface Assistants {
     ...
     */
    @BetaOpenAI
    suspend fun assistant(id: AssistantId, request: AssistantRequest): Assistant
     ...
     */
    @BetaOpenAI
    suspend fun createFile(assistantId: AssistantId, fileId: FileId): AssistantFile
     ...
     */
    @BetaOpenAI
    suspend fun file(assistantId: AssistantId, fileId: FileId): AssistantFile
     ...
     */
    @BetaOpenAI
    suspend fun delete(assistantId: AssistantId, fileId: FileId): Boolean
