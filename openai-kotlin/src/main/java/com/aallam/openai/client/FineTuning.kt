...
interface FineTuning {
     ...
     */
    suspend fun fineTuningJob(request: FineTuningRequest): FineTuningJob
     ...
     */
    suspend fun fineTuningJobs(after: String? = null, limit: Int? = null): List<FineTuningJob>
     ...
     */
    suspend fun fineTuningJob(id: FineTuningId): FineTuningJob?
     ...
     */
    suspend fun cancel(id: FineTuningId): FineTuningJob?
