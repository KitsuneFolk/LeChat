 ...
 */
@ExperimentalOpenAI
fun Embedding.similarity(other: Embedding): Double = Cosine.similarity(embedding, other.embedding)

/**
 * Calculate the distance between two embeddings, corresponding to 1.0 - similarity.
 */
@ExperimentalOpenAI
fun Embedding.distance(other: Embedding): Double = Cosine.distance(embedding, other.embedding)
