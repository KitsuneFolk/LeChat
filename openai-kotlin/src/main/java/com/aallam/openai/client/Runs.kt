...
interface Runs {
     ...
     */
    @BetaOpenAI
    suspend fun updateRun(threadId: ThreadId, runId: RunId, metadata: Map<String, String>? = null): Run
     ...
     */
    @BetaOpenAI
    suspend fun cancel(threadId: ThreadId, runId: RunId): Run
     ...
     */
    @BetaOpenAI
    suspend fun createThreadRun(request: ThreadRunRequest): Run
     ...
     */
    @BetaOpenAI
    suspend fun runStep(threadId: ThreadId, runId: RunId, stepId: RunStepId): RunStep
