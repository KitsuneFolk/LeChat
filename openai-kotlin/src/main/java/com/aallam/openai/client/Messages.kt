...
interface Messages {
     ...
     */
    @BetaOpenAI
    suspend fun message(threadId: ThreadId, messageId: MessageId, metadata: Map<String, String>? = null): Message
     ...
     */
    @BetaOpenAI
    suspend fun messageFile(threadId: ThreadId, messageId: MessageId, fileId: FileId): MessageFile
