...
data class FunctionCall(
     ...
     */
    fun argumentsAsJson(json: Json = Json): JsonObject = json.decodeFromString(arguments)
     ...
     * @param json The Json object to be used for decoding, defaults to a default Json instance
     */
    fun argumentsAsJsonOrNull(json: Json = Json): JsonObject? = argumentsOrNull?.let { json.decodeFromString(it) }
}
