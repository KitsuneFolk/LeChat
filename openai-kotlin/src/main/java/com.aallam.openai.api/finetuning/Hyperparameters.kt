...
data class Hyperparameters(
    ...
    constructor(nEpochs: Int) : this(NEpochs(nEpochs))
    constructor(nEpochs: String) : this(NEpochs(nEpochs))
    ...
    sealed interface NEpochs {
        ...
        companion object {
             ...
             */
            operator fun invoke(value: Int): NEpochs = NEpochsInt(value)

            /**
             * Creates an [NEpochs] instance holding a [String] value.
             */
            operator fun invoke(value: String): NEpochs = NEpochsString(value)

            /**
             * A predefined [NEpochs] instance which indicates automatic determination of epochs.
             */
            val Auto: NEpochs = NEpochsString("auto")
        }
    }
}
