 ...
 */
fun fineTuningRequest(block: FineTuningRequestBuilder.() -> Unit): FineTuningRequest =
...
class FineTuningRequestBuilder {
     ...
     * The same data should not be present in both train and validation files.
     */
    var validationFile: FileId? = null

    /**
     * The hyperparameters used for the fine-tuning job (Optional).
     */
    var hyperparameters: Hyperparameters? = null
     ...
     */
    fun build(): FineTuningRequest = FineTuningRequest(
