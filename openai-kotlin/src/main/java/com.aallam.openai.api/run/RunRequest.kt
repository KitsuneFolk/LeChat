 ...
 */
@BetaOpenAI
fun runRequest(block: RunRequestBuilder.() -> Unit): RunRequest = RunRequestBuilder().apply(block).build()
...
class RunRequestBuilder {
     ...
     * The ID of the assistant to use to execute this run.
     */
    var assistantId: AssistantId? = null
     ...
     */
    fun build(): RunRequest = RunRequest(
